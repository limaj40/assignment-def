...
function quizQuestion() {
	...
	if (selectedOption1 == 'b') {
		...
		document.getElementById('ans1').innerHTML = "INCORRECT: the correct answer is B) USA"
	}
	...
	if (selectedOption2 == 'c') {
		...
		document.getElementById('ans2').innerHTML = "INCORRECT: the correct answer is C) Prime Minister"
	}
	...
	if (selectedOption3 == 'b') {
		...
		document.getElementById('ans3').innerHTML = "INCORRECT: the correct answer is B) Bulgaria"
	}
	...
	if (selectedOption4 == 'b') {
		...
		document.getElementById('ans4').innerHTML = "INCORRECT: the correct answer is B) Jeff Bezos"
	}
	...
	if (selectedOption5 == 'c') {
		...
		document.getElementById('ans5').innerHTML = "INCORRECT: the correct answer is C) Kapil Dev"
	}
